...
local function CreateGUI(title)
    ...
    agreeFrame.Text = "1.加入我QQ群155583711\n 2.脚本体验愉快\n 3.作者MO"
...
----------------------------------------------------------------------------------------------------------------------------------------
local window = library:new("MO")--V2
----------------------------------------------------------------------------------------------------------------------------------------
    ...
    bin:Label("会努力更新的")
    bin:Label("也感谢帮我的人")
    bin:Label("作者QQ：3461807465")
    bin:Label("发布日期：")
    bin:Label("感谢喝一口，神青鼎力相助")
...
credits:Button(
   ...
   credits:Button(
    ...
    local creds = window:Tab("CDID",'6035145364')
local credits = creds:section("功能", true)
...
credits:Button(
        "CDID钓鱼",
        function()
           loadstring(game:HttpGet("https://raw.githubusercontent.com/itsMeArul/QuaHUB/refs/heads/main/cdid.lua"))(); 
        end
    )
...
credits:Button(
        "CDID外网1",
        function()
            loadstring(game:HttpGetAsync("https://cdn.1intan99.my.id/files/2025/loaders/cdid.lua"))()
        end
    )
...
credits:Button(
        "驾驶帝国1",
        function()
            loadstring(game:HttpGet("https://raw.githubusercontent.com/3461807465/cs/refs/heads/main/%E9%A9%BE%E9%A9%B6%E5%B8%9D%E5%9B%BD.txt"))()
        end
    )
...
credits:Button(
        ...
        function()
            script_key = "KEY HERE";
loadstring(game:HttpGet("https://api.luarmor.net/files/v3/loaders/04b99e8d34f75aa43d215d0a8dca2ab6.lua"))()
        end
    )
    bin:Label("上面的卡密在-- Get a free key here: https://discord.gg/xGCzxdx5wq
-- PUT THE KEY IN BETWEEN THE " " (CAN'T BELIEVE I EVEN HAVE TO SAY THIS) FOR EXAMPLE: script_key = "MyAwesomeKey!";
")

credits:Button(
        "驾驶帝国自动农场",
        function()
            local scriptSource = loadstring(game:HttpGet("https://raw.githubusercontent.com/Kenniel123/Driving-Empire/refs/heads/main/Driving%20Empire%20AutoFarm%20Freemium"))()
        end
    )
...
credits:Button(
        "冷河北",
        function()
            loadstring(game:HttpGet("https://raw.githubusercontent.com/odhdshhe/Tang-County-Hebei-Province/refs/heads/main/LENG%20Tang%20County%2C%20Hebei%20Province.txt"))()
        end
    )
...
credits:Button(
    ...
    local creds = window:Tab("烂梗社区",'6035145364')
local credits = creds:section("功能", true)

credits:Button(
        "刷钱",
        function()
            loadstring(game:HttpGet(('https://raw.githubusercontent.com/XOTRXONY/EasyScript/main/Suao.luau'),true))()
        end
    )
    
    local creds = window:Tab("出租车",'6035145364')
local credits = creds:section("功能", true)
...
credits:Button(
    ...
    credits:Button(
        "刷钱",
        function()
            loadstring(game:HttpGet("https://getetronix.eu/script"))()
        end
    )
